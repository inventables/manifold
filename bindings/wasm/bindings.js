...
Module.setup = function () {
  ...
  function endTypeToInt(endType) {
    return endType == 'Polygon' ? 0 : endType == 'Joined' ? 1 :
      endType == 'Butt' ? 2 : endType == 'Square' ? 3 : /* Round */ 4;
  }
  ...
  Module.CrossSection.prototype.offset = function (
    delta, joinType = 'Square', endType = 'Polygon', miterLimit = 2.0,
    circularSegments = 0) {
    return this._Offset(
      delta, joinTypeToInt(joinType), endTypeToInt(endType), miterLimit,
      circularSegments);
  };
