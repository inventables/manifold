    ...
    async function (moduleArg = {}) {
      ...
      Module.setup = function () {
        ...
        function polygons2vec(polygons) {
          ...
          return toVec(new Module.Vector2_vec2, polygons, poly => toVec(new Module.Vector_vec2, poly, p => {
        ...
        function endTypeToInt(endType) {
          return endType == "Polygon" ? 0 : endType == "Joined" ? 1 : endType == "Butt" ? 2 : endType == "Square" ? 3 : 4
        }
        ...
        Module.CrossSection.prototype.offset = function (delta, joinType = "Square", endType = "Polygon", miterLimit = 2, circularSegments = 0) {
          return this._Offset(delta, joinTypeToInt(joinType), endTypeToInt(endType), miterLimit, circularSegments)
        };
        Module.CrossSection.prototype.extrude = function (height, nDivisions = 0, twistDegrees = 0, scaleTop = [1, 1], center = false) {
        ...
        Module.CrossSection.prototype.revolve = function (circularSegments = 0, revolveDegrees = 360) {
          return Module._Revolve(this._ToPolygons(), circularSegments, revolveDegrees)
        };
        ...
        Module.Manifold.prototype.smoothOut = function (minSharpAngle = 60, minSmoothness = 0) {
        ...
        Module.Manifold.prototype.calculateNormals = function (normalIdx, minSharpAngle = 60) {
        ...
        Module.CrossSection.square = function (...args) {
          let size = undefined;
          if (args.length == 0) size = {x: 1, y: 1}; else if (typeof args[0] == "number") size = {
            x: args[0],
            y: args[0]
        ...
        Object.defineProperty(Module.CrossSection, Symbol.hasInstance, {get: () => t => t instanceof CrossSectionCtor});
        ...
        Module.Manifold.cube = function (...args) {
          let size = undefined;
          if (args.length == 0) size = {x: 1, y: 1, z: 1}; else if (typeof args[0] == "number") size = {
            x: args[0],
            y: args[0],
            z: args[0]
        ...
        Module.Manifold.cylinder = function (height, radiusLow, radiusHigh = -1, circularSegments = 0, center = false) {
        ...
        Module.Manifold.extrude = function (polygons, height, nDivisions = 0, twistDegrees = 0, scaleTop = [1, 1], center = false) {
        ...
        Module.Manifold.levelSet = function (sdf, bounds, edgeLength, level = 0, tolerance = -1) {
          const bounds2 = {
          ...
          const out = Module._LevelSet(wasmFuncPtr, bounds2, edgeLength, level, tolerance);
          removeFunction(wasmFuncPtr);
          return out
        };
        ...
        Module.triangulate = function (polygons, epsilon = -1) {
          const polygonsVec = polygons2vec(polygons);
          const result = fromVec(Module._Triangulate(polygonsVec, epsilon), x => [x[0], x[1], x[2]]);
          disposePolygons(polygonsVec);
          return result
        }
      };
      ...
      function applySignatureConversions(wasmExports) {
        ...
        wasmExports["L"] = makeWrapper_pp(wasmExports["L"]);
